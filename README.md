...
| execution | `executing-plans` | Execute a written plan with subagent orchestration and quality gates. Home of Autonomy Mode — bounded autonomous execution, opt-in per grant, gated by the `autonomy-gate` hook on a fresh contract record. |
