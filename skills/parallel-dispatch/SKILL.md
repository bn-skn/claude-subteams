...
2. Multiple subsystems broken independently
3. Each problem can be understood without context from others
4. No shared state between investigations
...
**NEVER:**
- Dispatch agents that will edit the same files
- Skip verification after agents return
- Use parallel dispatch for related failures

**ALWAYS:**
- Provide full context in each agent prompt
- Verify agent results before integrating
