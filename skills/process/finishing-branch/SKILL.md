...
**Called by:**
- **claude-subteams:subagent-driven-dev** - After all tasks complete
- **claude-subteams:executing-plans** - After all batches complete

**Pairs with:**
- **claude-subteams:using-git-worktrees** - Cleans up worktree created by that skill
