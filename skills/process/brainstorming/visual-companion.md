...
#           "screen_dir":"/path/to/project/.claude-subteams/brainstorm/12345-1706000000/content",
#           "state_dir":"/path/to/project/.claude-subteams/brainstorm/12345-1706000000/state"}
```
...
3. **On your next turn** — read `$STATE_DIR/events` if it exists
